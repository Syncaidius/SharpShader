...
namespace SharpShader
{
	...
	public struct Vector2 : IVector<float>, IIntrinsicValue<float>
	{
		...
		/// <summary>
		///	Gets the <see cref="Type"/> of each element in a <see cref="Vector2"/>.
		/// </summary>
		...
		public static explicit operator UInt2(Vector2 val)
		{
			return new UInt2()
			{
				X = (uint)val.X,
		...
		public static explicit operator Int2(Vector2 val)
		{
			return new Int2()
			{
				X = (int)val.X,
		...
		public static explicit operator Double2(Vector2 val)
		{
			return new Double2()
			{
				X = (double)val.X,
