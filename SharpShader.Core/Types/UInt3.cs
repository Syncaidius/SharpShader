...
namespace SharpShader
{
	...
	{
		/// <summary>
		///	The number of elements (components) in a <see cref="UInt3"/>.
		/// </summary>
		public const int ELEMENT_COUNT = 3;
		
		/// <summary>
		///	The size of a <see cref="UInt3"/>, in bytes.
		/// </summary>
		public const int ELEMENT_SIZE = sizeof(uint);

		/// <summary>
		///	The size of a single element (component) within a <see cref="UInt3"/>, in bytes.
		/// </summary>
		public const int SIZE_OF = ELEMENT_COUNT * ELEMENT_SIZE;

		/// <summary>
		///	Gets the <see cref="Type"/> of each element in a <see cref="UInt3"/>.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets a component at the specified index for the current <see cref="UInt3"/> .
		/// </summary>
		public uint this[int index]
		{
			get
			{
				switch(index)
				{
					...
					case 1: return Y;
					case 2: return Z;
					default: throw new IndexOutOfRangeException("The maximum index of a UInt3 is 2.");
				}
			}
		}
		/// <summary>
