...
namespace SharpShader
{
	...
	{
		/// <summary>
		///	The number of elements (components) in a <see cref="Int4"/>.
		/// </summary>
		public const int ELEMENT_COUNT = 4;
		
		/// <summary>
		///	The size of a <see cref="Int4"/>, in bytes.
		/// </summary>
		public const int ELEMENT_SIZE = sizeof(int);

		/// <summary>
		///	The size of a single element (component) within a <see cref="Int4"/>, in bytes.
		/// </summary>
		public const int SIZE_OF = ELEMENT_COUNT * ELEMENT_SIZE;

		/// <summary>
		///	Gets the <see cref="Type"/> of each element in a <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets a component at the specified index for the current <see cref="Int4"/> .
		/// </summary>
		...
		public static explicit operator Vector4(Int4 val)
		{
			return new Vector4()
			{
				X = (float)val.X,
		...
		public static explicit operator UInt4(Int4 val)
		{
			return new UInt4()
			{
				X = (uint)val.X,
		...
		public static explicit operator Double4(Int4 val)
		{
			return new Double4()
			{
				X = (double)val.X,
