...
namespace SharpShader
{
	...
	public struct Vector3 : IVector<float>, IIntrinsicValue<float>
	{
		...
		/// <summary>
		///	Gets the <see cref="Type"/> of each element in a <see cref="Vector3"/>.
		/// </summary>
		...
		public static explicit operator UInt3(Vector3 val)
		{
			return new UInt3()
			{
				X = (uint)val.X,
		...
		public static explicit operator Int3(Vector3 val)
		{
			return new Int3()
			{
				X = (int)val.X,
		...
		public static explicit operator Double3(Vector3 val)
		{
			return new Double3()
			{
				X = (double)val.X,
