...
namespace SharpShader
{
	...
	public struct Int4 : IVector, IIntrinsicValue
	{
        /// <summary>
        /// The X component.
        /// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of X, W from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 XW => new Int2(X, W);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of R, A from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 RA => new Int2(R, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of Y, W from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 YW => new Int2(Y, W);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of G, A from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 GA => new Int2(G, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of Z, W from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 ZW => new Int2(Z, W);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of B, A from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 BA => new Int2(B, A);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of W, X from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 WX => new Int2(W, X);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of A, R from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 AR => new Int2(A, R);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of W, Y from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 WY => new Int2(W, Y);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of A, G from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 AG => new Int2(A, G);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of W, Z from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 WZ => new Int2(W, Z);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of A, B from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 AB => new Int2(A, B);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of W, W from the current <see cref="Int2"/>.
		/// </summary>
		public Int2 WW => new Int2(W, W);

		/// <summary>
		/// Returns a new <see cref="Int2"/> comprised of A, A from the current <see cref="Int2"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of X, X, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 XXW => new Int3(X, X, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of R, R, A from the current <see cref="Int3"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of X, Y, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 XYW => new Int3(X, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of R, G, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 RGA => new Int3(R, G, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of X, Z, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 XZW => new Int3(X, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of R, B, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 RBA => new Int3(R, B, A);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of X, W, X from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 XWX => new Int3(X, W, X);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of R, A, R from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 RAR => new Int3(R, A, R);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of X, W, Y from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 XWY => new Int3(X, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of R, A, G from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 RAG => new Int3(R, A, G);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of X, W, Z from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 XWZ => new Int3(X, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of R, A, B from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 RAB => new Int3(R, A, B);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of X, W, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 XWW => new Int3(X, W, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of R, A, A from the current <see cref="Int3"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Y, X, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 YXW => new Int3(Y, X, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of G, R, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 GRA => new Int3(G, R, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Y, Y, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 YYW => new Int3(Y, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of G, G, A from the current <see cref="Int3"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Y, Z, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 YZW => new Int3(Y, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of G, B, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 GBA => new Int3(G, B, A);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Y, W, X from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 YWX => new Int3(Y, W, X);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of G, A, R from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 GAR => new Int3(G, A, R);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Y, W, Y from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 YWY => new Int3(Y, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of G, A, G from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 GAG => new Int3(G, A, G);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Y, W, Z from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 YWZ => new Int3(Y, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of G, A, B from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 GAB => new Int3(G, A, B);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Y, W, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 YWW => new Int3(Y, W, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of G, A, A from the current <see cref="Int3"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Z, X, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ZXW => new Int3(Z, X, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of B, R, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 BRA => new Int3(B, R, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Z, Y, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ZYW => new Int3(Z, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of B, G, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 BGA => new Int3(B, G, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Z, Z, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ZZW => new Int3(Z, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of B, B, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 BBA => new Int3(B, B, A);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Z, W, X from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ZWX => new Int3(Z, W, X);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of B, A, R from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 BAR => new Int3(B, A, R);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Z, W, Y from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ZWY => new Int3(Z, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of B, A, G from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 BAG => new Int3(B, A, G);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Z, W, Z from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ZWZ => new Int3(Z, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of B, A, B from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 BAB => new Int3(B, A, B);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of Z, W, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ZWW => new Int3(Z, W, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of B, A, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 BAA => new Int3(B, A, A);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, X, X from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WXX => new Int3(W, X, X);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, R, R from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ARR => new Int3(A, R, R);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, X, Y from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WXY => new Int3(W, X, Y);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, R, G from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ARG => new Int3(A, R, G);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, X, Z from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WXZ => new Int3(W, X, Z);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, R, B from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ARB => new Int3(A, R, B);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, X, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WXW => new Int3(W, X, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, R, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ARA => new Int3(A, R, A);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, Y, X from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WYX => new Int3(W, Y, X);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, G, R from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 AGR => new Int3(A, G, R);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, Y, Y from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WYY => new Int3(W, Y, Y);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, G, G from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 AGG => new Int3(A, G, G);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, Y, Z from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WYZ => new Int3(W, Y, Z);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, G, B from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 AGB => new Int3(A, G, B);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, Y, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WYW => new Int3(W, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, G, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 AGA => new Int3(A, G, A);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, Z, X from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WZX => new Int3(W, Z, X);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, B, R from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ABR => new Int3(A, B, R);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, Z, Y from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WZY => new Int3(W, Z, Y);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, B, G from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ABG => new Int3(A, B, G);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, Z, Z from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WZZ => new Int3(W, Z, Z);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, B, B from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ABB => new Int3(A, B, B);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, Z, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WZW => new Int3(W, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, B, A from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 ABA => new Int3(A, B, A);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, W, X from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WWX => new Int3(W, W, X);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, A, R from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 AAR => new Int3(A, A, R);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, W, Y from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WWY => new Int3(W, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, A, G from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 AAG => new Int3(A, A, G);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, W, Z from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WWZ => new Int3(W, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, A, B from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 AAB => new Int3(A, A, B);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of W, W, W from the current <see cref="Int3"/>.
		/// </summary>
		public Int3 WWW => new Int3(W, W, W);

		/// <summary>
		/// Returns a new <see cref="Int3"/> comprised of A, A, A from the current <see cref="Int3"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, X, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XXXW => new Int4(X, X, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, R, R, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, X, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XXYW => new Int4(X, X, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, R, G, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, X, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XXZW => new Int4(X, X, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, R, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RRBA => new Int4(R, R, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, X, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XXWX => new Int4(X, X, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, R, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RRAR => new Int4(R, R, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, X, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XXWY => new Int4(X, X, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, R, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RRAG => new Int4(R, R, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, X, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XXWZ => new Int4(X, X, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, R, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RRAB => new Int4(R, R, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, X, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XXWW => new Int4(X, X, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, R, A, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Y, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XYXW => new Int4(X, Y, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, G, R, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Y, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XYYW => new Int4(X, Y, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, G, G, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Y, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XYZW => new Int4(X, Y, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, G, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RGBA => new Int4(R, G, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Y, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XYWX => new Int4(X, Y, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, G, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RGAR => new Int4(R, G, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Y, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XYWY => new Int4(X, Y, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, G, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RGAG => new Int4(R, G, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Y, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XYWZ => new Int4(X, Y, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, G, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RGAB => new Int4(R, G, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Y, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XYWW => new Int4(X, Y, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, G, A, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Z, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XZXW => new Int4(X, Z, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, B, R, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Z, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XZYW => new Int4(X, Z, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, B, G, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RBGA => new Int4(R, B, G, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Z, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XZZW => new Int4(X, Z, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, B, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RBBA => new Int4(R, B, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Z, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XZWX => new Int4(X, Z, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, B, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RBAR => new Int4(R, B, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Z, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XZWY => new Int4(X, Z, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, B, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RBAG => new Int4(R, B, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Z, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XZWZ => new Int4(X, Z, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, B, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RBAB => new Int4(R, B, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, Z, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XZWW => new Int4(X, Z, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, B, A, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RBAA => new Int4(R, B, A, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, X, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWXX => new Int4(X, W, X, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, R, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RARR => new Int4(R, A, R, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, X, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWXY => new Int4(X, W, X, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, R, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RARG => new Int4(R, A, R, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, X, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWXZ => new Int4(X, W, X, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, R, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RARB => new Int4(R, A, R, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWXW => new Int4(X, W, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, R, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RARA => new Int4(R, A, R, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, Y, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWYX => new Int4(X, W, Y, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, G, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RAGR => new Int4(R, A, G, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, Y, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWYY => new Int4(X, W, Y, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, G, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RAGG => new Int4(R, A, G, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, Y, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWYZ => new Int4(X, W, Y, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, G, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RAGB => new Int4(R, A, G, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWYW => new Int4(X, W, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, G, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RAGA => new Int4(R, A, G, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, Z, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWZX => new Int4(X, W, Z, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, B, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RABR => new Int4(R, A, B, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, Z, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWZY => new Int4(X, W, Z, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, B, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RABG => new Int4(R, A, B, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, Z, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWZZ => new Int4(X, W, Z, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, B, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RABB => new Int4(R, A, B, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWZW => new Int4(X, W, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RABA => new Int4(R, A, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWWX => new Int4(X, W, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RAAR => new Int4(R, A, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWWY => new Int4(X, W, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RAAG => new Int4(R, A, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWWZ => new Int4(X, W, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 RAAB => new Int4(R, A, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of X, W, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 XWWW => new Int4(X, W, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of R, A, A, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, X, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YXXW => new Int4(Y, X, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, R, R, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, X, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YXYW => new Int4(Y, X, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, R, G, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, X, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YXZW => new Int4(Y, X, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, R, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GRBA => new Int4(G, R, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, X, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YXWX => new Int4(Y, X, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, R, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GRAR => new Int4(G, R, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, X, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YXWY => new Int4(Y, X, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, R, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GRAG => new Int4(G, R, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, X, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YXWZ => new Int4(Y, X, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, R, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GRAB => new Int4(G, R, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, X, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YXWW => new Int4(Y, X, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, R, A, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Y, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YYXW => new Int4(Y, Y, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, G, R, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Y, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YYYW => new Int4(Y, Y, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, G, G, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Y, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YYZW => new Int4(Y, Y, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, G, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GGBA => new Int4(G, G, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Y, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YYWX => new Int4(Y, Y, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, G, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GGAR => new Int4(G, G, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Y, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YYWY => new Int4(Y, Y, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, G, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GGAG => new Int4(G, G, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Y, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YYWZ => new Int4(Y, Y, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, G, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GGAB => new Int4(G, G, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Y, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YYWW => new Int4(Y, Y, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, G, A, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Z, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YZXW => new Int4(Y, Z, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, B, R, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GBRA => new Int4(G, B, R, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Z, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YZYW => new Int4(Y, Z, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, B, G, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Z, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YZZW => new Int4(Y, Z, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, B, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GBBA => new Int4(G, B, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Z, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YZWX => new Int4(Y, Z, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, B, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GBAR => new Int4(G, B, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Z, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YZWY => new Int4(Y, Z, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, B, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GBAG => new Int4(G, B, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Z, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YZWZ => new Int4(Y, Z, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, B, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GBAB => new Int4(G, B, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, Z, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YZWW => new Int4(Y, Z, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, B, A, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GBAA => new Int4(G, B, A, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, X, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWXX => new Int4(Y, W, X, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, R, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GARR => new Int4(G, A, R, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, X, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWXY => new Int4(Y, W, X, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, R, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GARG => new Int4(G, A, R, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, X, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWXZ => new Int4(Y, W, X, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, R, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GARB => new Int4(G, A, R, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWXW => new Int4(Y, W, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, R, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GARA => new Int4(G, A, R, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, Y, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWYX => new Int4(Y, W, Y, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, G, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GAGR => new Int4(G, A, G, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, Y, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWYY => new Int4(Y, W, Y, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, G, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GAGG => new Int4(G, A, G, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, Y, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWYZ => new Int4(Y, W, Y, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, G, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GAGB => new Int4(G, A, G, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWYW => new Int4(Y, W, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, G, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GAGA => new Int4(G, A, G, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, Z, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWZX => new Int4(Y, W, Z, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, B, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GABR => new Int4(G, A, B, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, Z, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWZY => new Int4(Y, W, Z, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, B, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GABG => new Int4(G, A, B, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, Z, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWZZ => new Int4(Y, W, Z, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, B, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GABB => new Int4(G, A, B, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWZW => new Int4(Y, W, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GABA => new Int4(G, A, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWWX => new Int4(Y, W, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GAAR => new Int4(G, A, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWWY => new Int4(Y, W, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GAAG => new Int4(G, A, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWWZ => new Int4(Y, W, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 GAAB => new Int4(G, A, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Y, W, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 YWWW => new Int4(Y, W, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of G, A, A, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, X, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZXXW => new Int4(Z, X, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, R, R, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, X, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZXYW => new Int4(Z, X, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, R, G, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BRGA => new Int4(B, R, G, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, X, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZXZW => new Int4(Z, X, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, R, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BRBA => new Int4(B, R, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, X, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZXWX => new Int4(Z, X, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, R, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BRAR => new Int4(B, R, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, X, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZXWY => new Int4(Z, X, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, R, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BRAG => new Int4(B, R, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, X, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZXWZ => new Int4(Z, X, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, R, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BRAB => new Int4(B, R, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, X, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZXWW => new Int4(Z, X, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, R, A, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Y, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZYXW => new Int4(Z, Y, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, G, R, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BGRA => new Int4(B, G, R, A);
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Y, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZYYW => new Int4(Z, Y, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, G, G, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Y, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZYZW => new Int4(Z, Y, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, G, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BGBA => new Int4(B, G, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Y, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZYWX => new Int4(Z, Y, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, G, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BGAR => new Int4(B, G, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Y, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZYWY => new Int4(Z, Y, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, G, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BGAG => new Int4(B, G, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Y, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZYWZ => new Int4(Z, Y, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, G, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BGAB => new Int4(B, G, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Y, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZYWW => new Int4(Z, Y, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, G, A, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Z, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZZXW => new Int4(Z, Z, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, B, R, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Z, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZZYW => new Int4(Z, Z, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, B, G, A from the current <see cref="Int4"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Z, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZZZW => new Int4(Z, Z, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, B, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BBBA => new Int4(B, B, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Z, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZZWX => new Int4(Z, Z, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, B, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BBAR => new Int4(B, B, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Z, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZZWY => new Int4(Z, Z, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, B, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BBAG => new Int4(B, B, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Z, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZZWZ => new Int4(Z, Z, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, B, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BBAB => new Int4(B, B, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, Z, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZZWW => new Int4(Z, Z, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, B, A, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BBAA => new Int4(B, B, A, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, X, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWXX => new Int4(Z, W, X, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, R, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BARR => new Int4(B, A, R, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, X, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWXY => new Int4(Z, W, X, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, R, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BARG => new Int4(B, A, R, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, X, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWXZ => new Int4(Z, W, X, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, R, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BARB => new Int4(B, A, R, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWXW => new Int4(Z, W, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, R, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BARA => new Int4(B, A, R, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, Y, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWYX => new Int4(Z, W, Y, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, G, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BAGR => new Int4(B, A, G, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, Y, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWYY => new Int4(Z, W, Y, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, G, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BAGG => new Int4(B, A, G, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, Y, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWYZ => new Int4(Z, W, Y, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, G, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BAGB => new Int4(B, A, G, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWYW => new Int4(Z, W, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, G, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BAGA => new Int4(B, A, G, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, Z, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWZX => new Int4(Z, W, Z, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, B, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BABR => new Int4(B, A, B, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, Z, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWZY => new Int4(Z, W, Z, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, B, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BABG => new Int4(B, A, B, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, Z, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWZZ => new Int4(Z, W, Z, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, B, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BABB => new Int4(B, A, B, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWZW => new Int4(Z, W, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BABA => new Int4(B, A, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWWX => new Int4(Z, W, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BAAR => new Int4(B, A, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWWY => new Int4(Z, W, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BAAG => new Int4(B, A, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWWZ => new Int4(Z, W, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BAAB => new Int4(B, A, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of Z, W, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ZWWW => new Int4(Z, W, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of B, A, A, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 BAAA => new Int4(B, A, A, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, X, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXXX => new Int4(W, X, X, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, R, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARRR => new Int4(A, R, R, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, X, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXXY => new Int4(W, X, X, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, R, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARRG => new Int4(A, R, R, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, X, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXXZ => new Int4(W, X, X, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, R, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARRB => new Int4(A, R, R, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXXW => new Int4(W, X, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, R, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARRA => new Int4(A, R, R, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, Y, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXYX => new Int4(W, X, Y, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, G, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARGR => new Int4(A, R, G, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, Y, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXYY => new Int4(W, X, Y, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, G, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARGG => new Int4(A, R, G, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, Y, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXYZ => new Int4(W, X, Y, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, G, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARGB => new Int4(A, R, G, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXYW => new Int4(W, X, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, G, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARGA => new Int4(A, R, G, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, Z, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXZX => new Int4(W, X, Z, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, B, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARBR => new Int4(A, R, B, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, Z, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXZY => new Int4(W, X, Z, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, B, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARBG => new Int4(A, R, B, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, Z, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXZZ => new Int4(W, X, Z, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, B, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARBB => new Int4(A, R, B, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXZW => new Int4(W, X, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARBA => new Int4(A, R, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXWX => new Int4(W, X, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARAR => new Int4(A, R, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXWY => new Int4(W, X, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARAG => new Int4(A, R, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXWZ => new Int4(W, X, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARAB => new Int4(A, R, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, X, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WXWW => new Int4(W, X, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, R, A, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ARAA => new Int4(A, R, A, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, X, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYXX => new Int4(W, Y, X, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, R, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGRR => new Int4(A, G, R, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, X, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYXY => new Int4(W, Y, X, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, R, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGRG => new Int4(A, G, R, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, X, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYXZ => new Int4(W, Y, X, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, R, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGRB => new Int4(A, G, R, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYXW => new Int4(W, Y, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, R, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGRA => new Int4(A, G, R, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, Y, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYYX => new Int4(W, Y, Y, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, G, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGGR => new Int4(A, G, G, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, Y, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYYY => new Int4(W, Y, Y, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, G, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGGG => new Int4(A, G, G, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, Y, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYYZ => new Int4(W, Y, Y, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, G, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGGB => new Int4(A, G, G, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYYW => new Int4(W, Y, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, G, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGGA => new Int4(A, G, G, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, Z, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYZX => new Int4(W, Y, Z, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, B, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGBR => new Int4(A, G, B, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, Z, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYZY => new Int4(W, Y, Z, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, B, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGBG => new Int4(A, G, B, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, Z, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYZZ => new Int4(W, Y, Z, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, B, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGBB => new Int4(A, G, B, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYZW => new Int4(W, Y, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGBA => new Int4(A, G, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYWX => new Int4(W, Y, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGAR => new Int4(A, G, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYWY => new Int4(W, Y, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGAG => new Int4(A, G, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYWZ => new Int4(W, Y, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGAB => new Int4(A, G, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Y, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WYWW => new Int4(W, Y, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, G, A, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AGAA => new Int4(A, G, A, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, X, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZXX => new Int4(W, Z, X, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, R, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABRR => new Int4(A, B, R, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, X, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZXY => new Int4(W, Z, X, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, R, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABRG => new Int4(A, B, R, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, X, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZXZ => new Int4(W, Z, X, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, R, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABRB => new Int4(A, B, R, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZXW => new Int4(W, Z, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, R, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABRA => new Int4(A, B, R, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, Y, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZYX => new Int4(W, Z, Y, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, G, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABGR => new Int4(A, B, G, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, Y, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZYY => new Int4(W, Z, Y, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, G, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABGG => new Int4(A, B, G, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, Y, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZYZ => new Int4(W, Z, Y, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, G, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABGB => new Int4(A, B, G, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZYW => new Int4(W, Z, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, G, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABGA => new Int4(A, B, G, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, Z, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZZX => new Int4(W, Z, Z, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, B, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABBR => new Int4(A, B, B, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, Z, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZZY => new Int4(W, Z, Z, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, B, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABBG => new Int4(A, B, B, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, Z, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZZZ => new Int4(W, Z, Z, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, B, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABBB => new Int4(A, B, B, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZZW => new Int4(W, Z, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABBA => new Int4(A, B, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZWX => new Int4(W, Z, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABAR => new Int4(A, B, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZWY => new Int4(W, Z, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABAG => new Int4(A, B, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZWZ => new Int4(W, Z, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABAB => new Int4(A, B, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, Z, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WZWW => new Int4(W, Z, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, B, A, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 ABAA => new Int4(A, B, A, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, X, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWXX => new Int4(W, W, X, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, R, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AARR => new Int4(A, A, R, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, X, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWXY => new Int4(W, W, X, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, R, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AARG => new Int4(A, A, R, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, X, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWXZ => new Int4(W, W, X, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, R, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AARB => new Int4(A, A, R, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, X, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWXW => new Int4(W, W, X, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, R, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AARA => new Int4(A, A, R, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, Y, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWYX => new Int4(W, W, Y, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, G, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AAGR => new Int4(A, A, G, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, Y, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWYY => new Int4(W, W, Y, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, G, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AAGG => new Int4(A, A, G, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, Y, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWYZ => new Int4(W, W, Y, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, G, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AAGB => new Int4(A, A, G, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, Y, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWYW => new Int4(W, W, Y, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, G, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AAGA => new Int4(A, A, G, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, Z, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWZX => new Int4(W, W, Z, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, B, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AABR => new Int4(A, A, B, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, Z, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWZY => new Int4(W, W, Z, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, B, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AABG => new Int4(A, A, B, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, Z, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWZZ => new Int4(W, W, Z, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, B, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AABB => new Int4(A, A, B, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, Z, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWZW => new Int4(W, W, Z, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, B, A from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AABA => new Int4(A, A, B, A);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, W, X from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWWX => new Int4(W, W, W, X);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, A, R from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AAAR => new Int4(A, A, A, R);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, W, Y from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWWY => new Int4(W, W, W, Y);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, A, G from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AAAG => new Int4(A, A, A, G);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, W, Z from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWWZ => new Int4(W, W, W, Z);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, A, B from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 AAAB => new Int4(A, A, A, B);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of W, W, W, W from the current <see cref="Int4"/>.
		/// </summary>
		public Int4 WWWW => new Int4(W, W, W, W);

		/// <summary>
		/// Returns a new <see cref="Int4"/> comprised of A, A, A, A from the current <see cref="Int4"/>.
		/// </summary>
