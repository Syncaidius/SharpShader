...
namespace SharpShader
{
	...
	public struct Matrix4x4 : IMatrix<float>, IIntrinsicValue<float>, UniformDimensions
	{
		/// <summary>
		///	The number of rows in a <see cref="Matrix4x4"/>.
		/// </summary>
		public const int ROW_COUNT = 4;

		/// <summary>
		///	The number of columns in a <see cref="Matrix4x4"/>.
		/// </summary>
		public const int COLUMN_COUNT = 4;

		/// <summary>
		///	The size of a <see cref="Matrix4x4"/>, in bytes.
		/// </summary>
		public const int ELEMENT_SIZE = sizeof(float);

		/// <summary>
		///	The size of a single element within a <see cref="Matrix4x4"/>, in bytes.
		/// </summary>
		public const int SIZE_OF = (ROW_COUNT * COLUMN_COUNT) * ELEMENT_SIZE;

		/// <summary>
		///	Gets the <see cref="Type"/> of each element in a <see cref="Matrix4x4"/>.
		/// </summary>
		...
		/// <summary>
		/// Creates a new instance of <see cref="Matrix4x4"/>.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets a component at the specified index for the current <see cref="Matrix4x4"/> .
		/// </summary>
